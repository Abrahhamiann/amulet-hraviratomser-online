...
const en = {
  ...
  faqItems: [
    ...
    ['What languages are available?', 'Invitations can be prepared in Armenian, English, and Russian.'],
...
const hy = {
  ...
  faqItems: [
    ...
    ['Ի՞նչ լեզուներ են հասանելի', 'Հրավերները կարող են պատրաստվել հայերեն, անգլերեն և ռուսերեն։'],
...
Object.assign(ru, {
  ...
  faqItems: [
    ...
    ['Какие языки доступны?', 'Приглашения можно подготовить на армянском, английском и русском языках.'],
...
Object.assign(hy, {
  ...
  editorExitTitle: 'Պահպանե՞լ փոփոխությունները',
  editorExitDescription: 'Դուք պատրաստվում եք դուրս գալ հրավերի խմբագրիչից։ Կարող եք պահպանել փոփոխությունները կամ վերադարձնել շաբլոնի սկզբնական տեսքը։',
  editorExitSave: 'Պահպանել և դուրս գալ',
  editorExitDiscard: 'Չպահպանել'
});
Object.assign(en, {
  editorSessionChanges: 'Changes are saved automatically on this device',
  editorExitTitle: 'Save your changes?',
  editorExitDescription: 'You are leaving the invitation editor. Keep your changes or restore the template to its original state.',
  editorExitSave: 'Save and exit',
  editorExitDiscard: 'Discard changes'
});
Object.assign(ru, {
  editorSessionChanges: 'Изменения автоматически сохранены на этом устройстве',
  editorExitTitle: 'Сохранить изменения?',
  editorExitDescription: 'Вы выходите из редактора приглашения. Сохраните изменения или верните шаблон к исходному виду.',
  editorExitSave: 'Сохранить и выйти',
